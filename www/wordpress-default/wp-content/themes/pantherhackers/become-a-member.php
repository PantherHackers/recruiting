...
<div class="wrapper single-page">
	<h2 class="heading top-heading">Become a member</h2>
	...
	<form action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="POST" class="become-a-member-form">
		...
		<div class="form-group">
			<label for="f_email">Panther ID:</label>
			<input type="text" class="form-control" name="panther_id" id="f_email" placeholder="ex: ecullen1" value="<?php echo @$_POST['panther_id']; ?>">
		</div>
		<div class="form-group">
